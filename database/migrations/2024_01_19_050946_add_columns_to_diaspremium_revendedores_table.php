...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('diaspremium_revendedores', function (Blueprint $table) {
            ...
            $table->string('slug')->unique()->after('user_id'); // Asegúrate de que sea única
        });
    }
    ...
    {
        Schema::table('diaspremium_revendedores', function (Blueprint $table) {
            $table->dropColumn(['slug', 'estado_conectado', 'ultimo_conexion', 'pais', 'numero_telefono', 'mensaje_perfil', 'transacciones_exitosas', 'transacciones_rechazadas', 'transacciones_canceladas', 'nombres_beneficiario', 'apellidos_beneficiario', 'link_telegram', 'link_whatsapp', 'metodos_pago', 'cantidad_minima', 'precio']);
        });
    }
};
