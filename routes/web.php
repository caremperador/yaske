...
Route::controller(VideoController::class)->group(function () {
    ...
    Route::get('/capitulos/crear', 'storeCapitulos')->name('capitulos.store')->middleware('responseCache:60');
});
...
Route::controller(TipoController::class)->group(function () {
    ...
    Route::get('/tipo/{tipoSlug}/{categoria?}', 'show_con_listas')->name('tipos.show_con_listas')->middleware('auth');
});
