...
<div class="fixed top-0 left-0 right-0 z-50 bg-blue-600" id="alert-message" style="display: none;">
      ...
      <div class="w-0 flex-1 flex items-center">
        ...
        <p class="ml-3 font-medium text-white truncate">
          ...
          <span class="hidden md:inline">
            Dilo.nu ahora será Yaske.ru. ¡Encuentra series, animes, películas, doramas, novelas y más en un solo sitio!
          </span>
        </p>
      </div>
