...
<div class="flex items-center justify-center">
    <div class="max-w-4xl bg-gray-800 rounded-lg shadow-xl overflow-hidden p-8 m-4">
        <div class="text-center">
            ...
            <a href="https://bit.ly/42SH4br" class="inline-block bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded transition ease-in-out duration-150 mb-4">
