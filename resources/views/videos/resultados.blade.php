                        ...
                        <a href="{{ route('videos.show', $video->id) }}" class="block">
                            <div class="flex items-start p-4">
                                <div class="flex-shrink-0">
                                    <img src="{{ asset('storage/' . $video->thumbnail) }}" alt="{{ $video->titulo }}" class="max-w-full max-h-full h-20 w-40 object-cover">

                                    @if ($video->lista)
                                        <div class="mt-2">
                                            <a href="{{ route('listas.show', $video->lista->id) }}"
                                                class="text-sm bg-gray-700 px-3 py-1 rounded text-white hover:bg-gray-600 transition duration-150 ease-in-out">
