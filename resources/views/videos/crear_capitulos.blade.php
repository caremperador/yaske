...
<div class="bg-gray-800 p-6 rounded-lg shadow-lg text-white max-w-4xl mx-auto my-10">
    ...
    <form action="{{ route('capitulos.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-6">
            ...
            <input type="text" name="tmdb_url" id="tmdb_url" class="bg-gray-700 border border-gray-600 text-white text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
        </div>

        <div class="mb-6">
            <label for="thumbnail_preview" class="block mb-2 text-sm font-medium">Previsualización de la Miniatura:</label>
            <img id="thumbnail_preview" src="" alt="Previsualización de la miniatura" class="hidden w-full max-w-xs mx-auto rounded-lg">
        </div>
        ...
        <div class="mb-6">
            ...
            <input type="file" name="thumbnail" id="thumbnail" class="bg-gray-700 border border-gray-600 text-white text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
        </div>
        ...
        <div class="mb-6">
            ...
            <input type="text" name="titulo" id="titulo" required class="bg-gray-700 border border-gray-600 text-white text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
        </div>

        <div class="mb-6">
            <label for="descripcion" class="block mb-2 text-sm font-medium">Descripción del Capítulo</label>
            <textarea name="descripcion" id="descripcion" required class="bg-gray-700 border border-gray-600 text-white text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" rows="4"></textarea>
        </div>

        <div class="mb-6">
            <label for="url_video" class="block mb-2 text-sm font-medium">URL del Video (Inglés)</label>
            <input type="text" name="url_video" id="url_video" class="bg-gray-700 border border-gray-600 text-white text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
        </div>

        <div class="mb-6">
            <label for="es_url_video" class="block mb-2 text-sm font-medium">URL del Video (Español)</label>
            <input type="text" name="es_url_video" id="es_url_video" class="bg-gray-700 border border-gray-600 text-white text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
        </div>

        <div class="mb-6">
            <label for="lat_url_video" class="block mb-2 text-sm font-medium">URL del Video (Latino)</label>
            <input type="text" name="lat_url_video" id="lat_url_video" class="bg-gray-700 border border-gray-600 text-white text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
        </div>

        <div class="mb-6">
            <label for="sub_url_video" class="block mb-2 text-sm font-medium">URL del Video (Subtítulos)</label>
            <input type="text" name="sub_url_video" id="sub_url_video" class="bg-gray-700 border border-gray-600 text-white text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
        </div>

        <div class="mb-6">
            <label for="estado" class="block mb-2 text-sm font-medium">Estado</label>
            <select name="estado" id="estado" class="bg-gray-700 border border-gray-600 text-white text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
                <option value="1">Premium</option>
                <option value="0">Gratis</option>
            </select>
        </div>

        <button type="submit" class="w-full text-white bg-blue-600 hover:bg-blue-700 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Agregar Capítulo</button>
    </form>
</div>
