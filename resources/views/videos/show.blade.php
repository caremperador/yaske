                ...
                <div class="flex items-center my-1">
                    ...
                    <div class="w-full bg-gray-700 rounded-full h-2 overflow-hidden">
                        <div class="bg-green-500 h-2"
                            style="width: {{ $totalOpiniones > 0 ? ($cantidad / $totalOpiniones) * 100 : 0 }}%"></div>
                    </div>
                </div>
            @endforeach
        </div>
        ...
        @auth
            <div class="my-4">
                ...
                <form action="{{ route('videos.puntuar', $video) }}" method="POST" id="rating-form">
                    ...
                    <button type="submit" class="mt-2 px-4 py-2 bg-blue-500 text-white rounded hover:bg-blue-700">Enviar
                        Puntuación</button>
                </form>
            </div>
        @endauth
